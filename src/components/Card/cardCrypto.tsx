  ...
  return (
    <div className="max-w-[315px] w-full h-[396px] m-[150px] flex flex-col justify-center items-center bg-[#262626] rounded-md">
      <img
        ...
        src="https://xstore.b-cdn.net/elementor2/nft-crypto/wp-content/uploads/sites/13/2023/08/Single-product-image4-min-400x400.jpg"
        alt=""
      />
      <div className="w-[285] h-[90px] flex flex-col justify-start">
        <h2 className="w-[285px] h-[24px] ">CryptPunk Bucket</h2>
        <p>
          <IoLogoBitcoin />
          0,009908
        </p>
